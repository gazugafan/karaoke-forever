const log = require('./lib/Log')
  .set('console', process.env.KE_SCANNER_CONSOLE_LEVEL, process.env.NODE_ENV === 'development' ? 5 : 4)
  .set('file', process.env.KE_SCANNER_LOG_LEVEL, process.env.NODE_ENV === 'development' ? 0 : 3)
